...
function sendDupli(){
  ...
  var sub = 'Your Registration for PROJECT EXPO has been Cancelled!!!'
  for(i=2;i<=to;i++)
  {
...
function assignID(r){
  var s = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("Sheet1");
  var man = "PRO";
  s.getRange(r,17).setValue(man+(1000+r-1));
}
