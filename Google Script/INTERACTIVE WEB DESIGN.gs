...
function sendDupli(){
  ...
  var sub = 'Your Registration for INTERACTIVE WEB DESIGN has been Cancelled!!!'
  for(i=2;i<=to;i++)
  {
...
function assignID(r){
  var s = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("Sheet1");
  var man = "IWD";
  s.getRange(r,15).setValue(man+(1000+r-1));
}
