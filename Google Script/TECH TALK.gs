...
function sendDupli(){
  ...
  var sub = 'Your Registration for TECH TALK has been Cancelled!!!'
  for(i=2;i<=to;i++)
  {
...
function assignID(r){
  var s = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("Sheet1");
  var man = "TT";
  s.getRange(r,11).setValue(man+(1000+r-1));
}
